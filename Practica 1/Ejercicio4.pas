...
begin
	...
	assign(carga, 'C:\Users\guada\Desktop\FACULTAD\2021\PRIMERSEMESTRE\FOD\Practica 1\todos_empleados.txt');
	reset(arch);
	rewrite(carga);
...
begin
	...
	assign(carga, 'C:\Users\guada\Desktop\FACULTAD\2021\PRIMERSEMESTRE\FOD\Practica 1\faltaDNIEmpleado.txt');
	reset(arch);
	rewrite(carga);
	while(not eof(arch)) do begin
		read(arch,e);
